...
<form action="saveeditcustomer.php" method="post">
  ...
  <div id="ac">
    ...
    <span>Location : </span><input type="text" style="width:265px; height:30px;" name="memno"
    ...
    <span>Registration Date: </span><input type="date" style="width:265px; height:30px;" name="date"
