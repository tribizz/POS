  ...
  <div id="header">
    ...
    <?php
				$id = (int) $_SESSION['SESS_MEMBER_ID'];
					...
					$query = mysqli_query ($db, "SELECT * FROM customer WHERE customer_id = '$id' ") or die (mysqli_error($db));
					$fetch = mysqli_fetch_array ($query);
			?>

    <ul>
      <li><a href="function/logout.php"><i class="icon-off icon-white"></i>logout</a></li>
      <li>Welcome:&nbsp;&nbsp;&nbsp;<a href="#profile" data-toggle="modal"><i
            class="icon-user icon-white"></i><?php echo $fetch['customer_name']; ?>&nbsp;<?php echo $fetch['customer_name'];?></a>
      </li>
    </ul>
  </div>
          ...
          <center>
            <table>
              <tr>
                ...
                <td class="profile">
                  <?php echo $fetch['firstname'];?>&nbsp;<?php echo $fetch['mi'];?>&nbsp;<?php echo $fetch['customer_name'];?>
                </td>
              </tr>
              <tr>
