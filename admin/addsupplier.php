...
<form action="savesupplier.php" method="post">
  ...
  <div id="ac">
    ...
    <span>Location : </span><input type="text" style="width:265px; height:30px;" name="cperson" /><br>
    <span>Contact No. : </span><input type="number" style="width:265px; height:30px;" name="contact" /><br>
