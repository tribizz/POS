...
<form action="saveeditsupplier.php" method="post">
  ...
  <div id="ac">
    ...
    <span>Location : </span><input type="text" style="width:265px; height:30px;" name="cperson"
      value="<?php echo $row['contact_person']; ?>" /><br>
    <span>Contact No.: </span><input type="number" style="width:265px; height:30px;" name="contact"
